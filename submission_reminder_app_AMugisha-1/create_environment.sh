...
if ! grep -q "Alice,CS101,submitted" submission_reminder_app/assets/submissions.txt; then
    # Add 5 student records to the correct submissions.txt file in assets
    echo "Alice,CS101,submitted" >> submission_reminder_app/assets/submissions.txt
    echo "Bob,CS102,not submitted" >> submission_reminder_app/assets/submissions.txt
    echo "Charlie,CS103,submitted" >> submission_reminder_app/assets/submissions.txt
    echo "David,CS104,not submitted" >> submission_reminder_app/assets/submissions.txt
    echo "Eva,CS105,submitted" >> submission_reminder_app/assets/submissions.txt
fi
